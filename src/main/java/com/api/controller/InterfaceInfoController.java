...
//import com.project.model.dto.interfaceinfo.InterfaceInfoEditRequest;
...
//        }
        ...
        String res = apiClient.TestExist(interfaceInfoName);
...
//        return ResultUtils.success(usernameByPost);
        ...
        String interfaceInfoName = oldInterfaceInfo.getName();
        String res = tempClient.mainInvoke(userRequestParams, interfaceInfoName);
        return ResultUtils.success(res);
    }
    @Resource
    private UserInterfaceInfoService userInterfaceInfoService;
    @PostMapping("/adddd")
    public boolean testaaa(int interfaceInfoId, int userId){
